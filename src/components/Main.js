    ...
    return (
      ...
      >
        ...
        >
          ...
          <p>
            I consider myself a resilient, understanding, cheerful and adaptable
            person to changes. In addition to being collaborative and teaching
            or collaborating in what is possible. of course self-taught. <br></br>
            Always looking for new challenges and learning new things.
          </p>
          {close}
        </article>
